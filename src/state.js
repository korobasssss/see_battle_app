...
let store = {
    ...
    _setStatusGame(status) {
        ...
        console.log(status)
        console.log("befor", this._state.game.status.game)
        this._state.game.status.game = status
        console.log("after", this._state.game.status.game)
    ...
    dispatch(action) {
        switch (action.type) {
            case SET_PLAYER_NAME: {
                this._state.player.name = action.name
                console.log(this._state.player.name)
                this._renderer()
                break
            }
            case SET_OPPONENT_NAME: {
                this._state.opponent.name = action.name
                console.log(this._state.opponent.name)
                this._renderer()
                break
            }
            case ARRANGE_PLAYER: {
            ...
            case START_GAME: {
                ...
                if (this.statusGame() === "NOT_START") {
                    this._setStatusGame("GAME")
            ...
            case NEW_GAME: {
                this._setStatusGame("NOT_START")
                this._state.game.status.arrange = false
                break
            }
            case ATTACK: {
                if (this.statusGame() === "GAME") {
            ...
            case ATTACK_II: {
                if (this.statusGame() === "GAME" && this._state.game.OPPONENT === "II") {
            ...
            case SET_GAME_TYPE_OPPONENT: {
                this._state.game.OPPONENT = action.oppType
                this._renderer()
                break
            }
            case SET_GAME_TYPE: {
                this._state.game.TYPE = action.gameType
                break
            }
            default:
        }
